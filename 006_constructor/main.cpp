// constructor is a special type of method that runs everytime we CREATE instantiate an object, by any means
// they have name same as the class name with no return type
